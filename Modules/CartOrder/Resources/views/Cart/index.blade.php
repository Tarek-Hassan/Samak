                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        <li class="m-portlet__nav-item">
                            <button onclick="window.location='{{ route('cart.create') }}'"
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>{{ __('general.cart_img') }}</th>
                                        <th>{{ __('general.cart_nameAr') }}</th>
                                        <th>{{ __('general.cart_nameEn') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('storage/'.$value->cart_img) }}" id="flag"
                                                style="width:50px;">
                                        </td>
