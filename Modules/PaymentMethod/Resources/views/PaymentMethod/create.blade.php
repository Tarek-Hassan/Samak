...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <form class="forms-sample col-md-9" action="{{ route('paymentmethod.store') }}" method="post"
                enctype="multipart/form-data">

                @csrf
                <div class="form-group">
                    <label for="exampleInputName1">paymentmethod</label>
                    <input type="text" class="form-control" name="paymentmethod" value="{{ old('paymentmethod') }}" id="exampleInputName1"
