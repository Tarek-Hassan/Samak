...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <form class="forms-sample col-md-9" action="{{ route('category.store') }}" method="post"
                enctype="multipart/form-data">

                @csrf
                <div class="form-group">
                    <label for="exampleInputName1">category_nameAr</label>
                    <input type="text" class="form-control" name="category_nameAr" value="{{ old('category_nameAr') }}" id="exampleInputName1"
                        placeholder="category_nameAr">
                </div>
                <div class="form-group">
                    <label for="exampleInputName1">category_nameEn</label>
                    <input type="text" class="form-control" name="category_nameEn" value="{{ old('category_nameEn') }}" id="exampleInputName1"
                        placeholder="category_nameEn">
                </div>
