                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>{{ __('general.category_img') }}</th>
                                        <th>{{ __('general.category_nameAr') }}</th>
                                        <th>{{ __('general.category_nameEn') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{$value->category_nameAr}}
                                        </td>
                                        <td>

                                            {{$value->category_nameEn}}
                                        </td>

                                        <td>
                                            <a href="category/{{$value->id}}/edit"><button type="button"
